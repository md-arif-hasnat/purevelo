...
export default function Home() {
  ...
  return <>
    ...
    <section className="contact-details"><div className="shell contact-details-grid"><div><p className="eyebrow navy">Contact</p><h2>Velora Grain & Foods</h2></div><address>Industrial Drive, Plot No. E-128/E,<br/>Baramati MIDC, Bhigwan Road, Baramati,<br/>District: Pune, Maharashtra - 413133, India</address></div></section></main><footer><div className="shell footer-grid"><img className="footer-logo" src="/purevelo-logo.png" alt="PureVelo"/><p>Premium Durum Wheat Vermicelli & Pasta</p><p>© 2026 PureVelo · Velora Grain & Foods</p></div></footer>
